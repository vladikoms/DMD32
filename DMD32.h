...
#define PIN_DMD_nOE		19 		// D19 active low Output Enable, setting this low lights all the LEDs in the selected rows. Can pwm it at very high frequency for brightness control.
#define PIN_DMD_A		16		// D16
#define PIN_DMD_B		17		// D17
#define PIN_DMD_CLK		18		// D18_SCK  is SPI Clock if SPI is used
#define PIN_DMD_SCLK		4		// D04
